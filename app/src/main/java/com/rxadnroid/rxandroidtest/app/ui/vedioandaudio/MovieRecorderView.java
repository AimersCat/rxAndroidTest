package com.rxadnroid.rxandroidtest.app.ui.vedioandaudio;
...
import com.rxadnroid.rxandroidtest.app.AppConfig;
...
//        params.setPictureSize(480, 720);//拍照保存比率
    ...
    private void createRecordDir() {
        File sampleDir = new File(AppConfig.getAppConfig(context).DEFAULT_SAVE_VEDIO_PATH);
        if (!sampleDir.exists()) {
            sampleDir.mkdirs();
        }
        try {
